    ...
    public function run()
    {
        ...
        $ngos = [
            ...
            [
                ...
                'registration_id' => 'NGO-JCF-1976',
                'phone' => '01755000006',
                'email' => 'info@jcfbd.org',
                'website' => 'jcfbd.org',
                'focus_areas' => ['Education', 'Community Development', 'Women Empowerment'],
                'status' => 'approved',
                'logo' => 'logos/jcf.png',
                'description' => 'Jagorani Chakra Foundation (JCF) is a leading NGO in Bangladesh, established in 1976, working for education, women empowerment, and community development in the southwest region.',
                'location' => 'Jessore, Khulna',
                'focus_area' => 'Women Empowerment',
                'focus_activity' => 'Vocational training for women, microcredit, and literacy programs',
                'certificate_path' => 'certificates/jcf_certificate.pdf',
                'established_year' => '1976',
            ],
            [
                'name' => 'Shakti Foundation',
                'registration_id' => 'NGO-SHKTI-1992',
                'phone' => '01755000007',
                'email' => 'info@shakti.org.bd',
                'website' => 'shakti.org.bd',
                'focus_areas' => ['Financial Inclusion', 'Women Empowerment'],
                'status' => 'approved',
                'logo' => 'logos/shakti.png',
                'description' => 'Shakti Foundation is a prominent NGO in Bangladesh, established in 1992, focusing on financial inclusion and women empowerment through microfinance and social development programs.',
                'location' => 'Dhaka',
                'focus_area' => 'Financial Inclusion',
                'focus_activity' => 'Microfinance, entrepreneurship training, and health awareness',
                'certificate_path' => 'certificates/shakti_certificate.pdf',
