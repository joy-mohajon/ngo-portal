...
<head>
    ...
    <title>All Projects | NGO Portal</title>
...
<body class="bg-gray-50">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <div class="flex items-center bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                    <div class="text-center px-4 border-r border-white/20">
                        ...
                        <div class="text-sm text-blue-100">Total Projects</div>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li><a href="{{ url('/public/projects') }}" class="hover:text-white">Projects</a></li>
                    </ul>
                </div>
                <div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Add smooth scrolling to all filter focus area clicks
        const filterButtons = document.querySelectorAll('#focus_area, #status');
