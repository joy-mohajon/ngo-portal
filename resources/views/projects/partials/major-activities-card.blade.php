    ...
    <div class="px-6 py-5">
        <ul class="text-sm text-gray-700 space-y-4">
            <li class="flex items-start space-x-3">
                ...
                <span>Farmer training on sustainable agriculture practices</span>
            </li>
            <li class="flex items-start space-x-3">
                <div class="mt-1">
                    <svg class="h-4 w-4 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span>Installation of improved irrigation systems</span>
            </li>
            <li class="flex items-start space-x-3">
                <div class="mt-1">
                    <svg class="h-4 w-4 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span>Distribution of high-yield crop varieties</span>
            </li>
            <li class="flex items-start space-x-3">
                <div class="mt-1">
                    <svg class="h-4 w-4 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span>Soil health management programs</span>
            </li>
            <li class="flex items-start space-x-3">
                <div class="mt-1">
                    <svg class="h-4 w-4 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span>Establishment of farmer cooperatives</span>
            </li>
        </ul>
    </div>
</div>