            ...
            <form method="POST" action="{{ route('ngos.update', $ngo->id) }}" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name"
                        ...
                        placeholder="Enter NGO name" value="{{ old('name', $ngo->name) }}" required />
                    @error('name')
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email"
                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                        placeholder="Contact email" value="{{ old('email', $ngo->email) }}" required />
                    @error('email')
                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="flex flex-row items-center justify-between mb-4 gap-4">
                    <div class="w-1/2 flex flex-col items-start">
                        ...
                        <input type="text" id="short_name" name="short_name"
                            class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            placeholder="Enter short name" required value="{{ old('short_name', $ngo->short_name) }}" />
                        @error('short_name')
                        <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div>
                    ...
                    <input type="url" id="website" name="website"
                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                        placeholder="https://example.org" value="{{ old('website', $ngo->website) }}" />
                    @error('website')
                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="text" id="location" name="location"
                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                        placeholder="City, Country" value="{{ old('location', $ngo->location) }}" required />
                    @error('location')
                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3"
                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                        placeholder="Brief description of the NGO">{{ old('description', $ngo->description) }}</textarea>
                    @error('description')
                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
