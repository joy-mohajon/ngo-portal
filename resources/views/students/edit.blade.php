    ...
    <div class="bg-white rounded-lg shadow overflow-hidden max-w-4xl mx-auto">
        ...
        <form action="{{ route('students.update', $student) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="mt-1 flex items-center">
                        <a href="{{ asset('storage/'.$student->national_id_file) }}" target="_blank"
                            class="text-blue-600 hover:text-blue-800 mr-4">View Current File</a>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="guardian_address" id="guardian_address" rows="2"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('guardian_address', $student->guardian_address) }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" name="education_institution" id="education_institution"
                        value="{{ old('education_institution', $student->education_institution) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="projects[]" id="project-{{ $project->id }}"
                                value="{{ $project->id }}"
                                {{ in_array($project->id, $student->projects->pluck('id')->toArray()) ? 'checked' : '' }}
                ...
                <div class="col-span-2 mt-2">
                    ...
                    <p class="text-xs text-gray-500 mb-1">This date will be used for all newly selected projects</p>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="notes" id="notes" rows="3"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('notes', $student->notes) }}</textarea>
            ...
            <div class="mt-6 flex justify-end">
                ...
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md">Update
                    Student</button>
            </div>
        </form>
    </div>
